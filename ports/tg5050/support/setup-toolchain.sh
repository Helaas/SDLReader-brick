...
TOOLCHAIN_BUILD=${TOOLCHAIN_BUILD:-v10.3.0-20251210-234416-816e71bd}
SYSROOT_TAR="sdk_tg5050_nextui.tgz"
SYSROOT_URL="https://github.com/LoveRetro/tg5050-toolchain/releases/download/sdk-20260122-164101/${SYSROOT_TAR}"
...
echo "Downloading TG5050 sysroot..."
